...
do_install() {
    ...
    then
        ...
        echo "DEFAULT disco" >> ${D}/boot/mmc0_extlinux/stm32mp157c-dk2_extlinux.conf
    fi
    echo "LABEL disco" >> ${D}/boot/mmc0_extlinux/stm32mp157c-dk2_extlinux.conf
    echo "	KERNEL /uImage" >> ${D}/boot/mmc0_extlinux/stm32mp157c-dk2_extlinux.conf
    echo "	FDT /stm32mp157c-dk2.dtb" >> ${D}/boot/mmc0_extlinux/stm32mp157c-dk2_extlinux.conf
    ...
    then
        ...
        echo "DEFAULT eval" >> ${D}/boot/mmc0_extlinux/stm32mp157c-ev1_extlinux.conf
    fi
    echo "DEFAULT eval" >> ${D}/boot/mmc0_extlinux/stm32mp157c-ev1_extlinux.conf
    echo "LABEL eval" >> ${D}/boot/mmc0_extlinux/stm32mp157c-ev1_extlinux.conf
    echo "	KERNEL /uImage" >> ${D}/boot/mmc0_extlinux/stm32mp157c-ev1_extlinux.conf
    echo "	FDT /stm32mp157c-ev1.dtb" >> ${D}/boot/mmc0_extlinux/stm32mp157c-ev1_extlinux.conf
